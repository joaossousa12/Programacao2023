...
bool compare_first(Pair<string, int> first, Pair<string, int> second){
    return first.get_first() < second.get_first();
}

bool compare_second(Pair<string, int> first, Pair<string, int> second){
    return first.get_first() < second.get_first();
}
