...
Date::Date(const std::string& year_month_day){
    ...
    if(iss >> year1 >> slash1 >> month1 >> slash2 >> day1 && slash1 == '/' && slash2 == slash1 && year1 >= 1 && year1 <= 9999 && month1 >= 1 && month1 <= 12 && day1 >= 1 && day1 <= num_days(year1, month1)){
         ostringstream oss;
        oss << setfill('0') << setw(4) << year1 << setw(2) << month1 << setw(2) << day1;
        yyyymmdd = oss.str();
    }
    else {
        yyyymmdd = "00000000";
