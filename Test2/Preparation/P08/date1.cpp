...
bool is_before(const Date& date1, const Date& date2){
    if(date2.get_year() > date1.get_year() || (date2.get_year() == date1.get_year() && date2.get_month() > date1.get_month()) || (date2.get_year() == date1.get_year() && date2.get_month() == date1.get_month() && date2.get_day() > date1.get_day()))
        return true;
    return false;
}
